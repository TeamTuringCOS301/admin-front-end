...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_config__ = __webpack_require__(51);
...
var ConservationAreaMasterPage = /** @class */ (function () {
    function ConservationAreaMasterPage(modCtrl, navParams, http) {
        ...
        var addr = __WEBPACK_IMPORTED_MODULE_3__app_config__["a" /* CONFIG */].url + "/area/list";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tabs_tabs__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_config__ = __webpack_require__(51);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.loginAdmin = function (value) {
        var _this = this;
        var addr = __WEBPACK_IMPORTED_MODULE_5__app_config__["a" /* CONFIG */].url + "/admin/login";
        var jsonArr = {
            "username": "",
            "password": ""
        };
...
var ConservationAdminMasterPage = /** @class */ (function () {
    function ConservationAdminMasterPage(modCtrl, http) {
        ...
        var addr = __WEBPACK_IMPORTED_MODULE_3__app_config__["a" /* CONFIG */].url + "/admin/list";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_conservation_admin_master_conservation_admin_master__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_store_master_store_master__ = __webpack_require__(103);
